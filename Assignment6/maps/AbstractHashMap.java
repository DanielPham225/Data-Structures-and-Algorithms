...
public abstract class AbstractHashMap<K,V> extends AbstractMap<K,V> {
  ...
  public AbstractHashMap(int cap, int p) {
    ...
    maxLoadFactor = 0.5; //default
    createTable();
  }

//user can set their own resize limit
  ...
  public V put(K key, V value) {
    ...
    if ((double) n / capacity > maxLoadFactor) { //new logic with maxLoadFactor
      resize(2 * capacity - 1);   // textbook strategy
    }
    return answer;
  }
