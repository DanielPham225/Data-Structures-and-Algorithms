...
// this is O(N) because this will run through all elements in the array
// dont depends on the position of the element, it will always loop through the whole array
